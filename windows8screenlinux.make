...
TARGETDIR = bin/Debug
TARGET = $(TARGETDIR)/windows8screenlinux
OBJDIR = obj/x64/Debug/windows8screenlinux
...
TARGETDIR = bin/Debug
TARGET = $(TARGETDIR)/windows8screenlinux
OBJDIR = obj/x86/Debug/windows8screenlinux
DEFINES += -DDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_GLFW_X11
...
TARGETDIR = bin/Debug
TARGET = $(TARGETDIR)/windows8screenlinux
OBJDIR = obj/ARM64/Debug/windows8screenlinux
DEFINES += -DDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_GLFW_X11
...
TARGET = $(TARGETDIR)/windows8screenlinux
OBJDIR = obj/x64/Release/windows8screenlinux
...
TARGETDIR = bin/Release
TARGET = $(TARGETDIR)/windows8screenlinux
OBJDIR = obj/x86/Release/windows8screenlinux
DEFINES += -DNDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_GLFW_X11
...
TARGETDIR = bin/Release
TARGET = $(TARGETDIR)/windows8screenlinux
OBJDIR = obj/ARM64/Release/windows8screenlinux
DEFINES += -DNDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_GLFW_X11
...
$(TARGET): $(GENERATED) $(OBJECTS) $(LDDEPS) | $(TARGETDIR)
	$(PRELINKCMDS)
	@echo Linking windows8screenlinux
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning windows8screenlinux
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
